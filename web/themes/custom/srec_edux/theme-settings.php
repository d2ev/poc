...
/**
 * @file
 * Custom setting for srec_edux theme.
 */
use Drupal\Core\Form\FormStateInterface;

function srec_edux_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $image_folder = $GLOBALS['base_url'] . '/' . \Drupal::service('extension.list.theme')->getPath('srec_edux') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
  $srec_eduxpro = '<img src="' . $image_folder . 'srec_eduxpro.png" />';
	$form['#attached']['library'][] = 'srec_edux/theme-settings';
  $form['srec_edux'] = [
    '#type'       => 'vertical_tabs',
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thank you for using srec_edux Theme</h3><strong>Edu X</strong> is a free Drupal 8, 9, 10, 11 theme designed and developed by <a href="https://drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'srec_edux',
  ];
  $form['layout'] = [
    '#type'  => 'details',
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://drupar.com/theme/srec_edux" target="_blank">Theme Homepage</a> || <a href="https://demo2.drupar.com/srec_edux/" target="_blank">Theme Demo</a> || <a href="https://drupar.com/doc/srec_edux" target="_blank">Theme Documentation</a> || <a href="https://drupar.com/doc/srec_edux/support" target="_blank">Theme Support</a>'),
  ];
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To Edu-X-Pro for $29 only'),
    '#description' => t('<p><a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Purchase Edu-X-Pro</a> || <a href="https://demo2.drupar.com/srec_eduxpro/" target="_blank">Edu-X-Pro Demo</a></p>') . $srec_eduxpro,
  ];
  /*
   * Layout
   */
  ...
  $form['layout']['layout_container']['container_width'] = [
    '#type'          => 'number',
    '#default_value' => theme_get_setting('container_width', 'srec_edux'),
  ...
  $form['layout']['layout_header']['header_width'] = [
    ...
    '#default_value' => theme_get_setting('header_width', 'srec_edux'),
  ];
  // Layout -> Main Layout
  ...
  $form['layout']['layout_main']['main_width'] = [
    ...
    '#default_value' => theme_get_setting('main_width', 'srec_edux'),
  ];
  ...
  $form['layout']['layout_footer']['footer_width'] = [
    ...
    '#default_value' => theme_get_setting('footer_width', 'srec_edux'),
  ];
  /*
   * Homepage slider
   */
  ...
  $form['slider']['slider_enable_option']['slider_show'] = [
    ...
    '#default_value' => theme_get_setting('slider_show', 'srec_edux'),
  ...
  $form['slider']['slider_speed_option']['slider_speed'] = [
    ...
    '#default_value' => theme_get_setting('slider_speed', 'srec_edux'),
  ...
  $form['slider']['slider_image_section']['slider_image_bg'] = [
    ...
    '#default_value' => theme_get_setting('slider_image_bg', 'srec_edux'),
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'srec_edux'),
    '#description'   => t('srec_edux theme has limitation of single image for slider. Separate image for each slide is available in srec_eduxPro. <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
  ];
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code', 'srec_edux'),
    '#description'   => t('Please refer to this <a href="https://drupar.com/doc/srec_edux/homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  /*
   * Header
   */
  ...
  $form['header']['header_links']['header_links_section'] = [
    '#type'        => 'fieldset',
    '#description'   => t('<a href="https://drupar.com/doc/srec_edux/how-manage-website-logo" target="_blank">Change Logo</a> || <a href="https://drupar.com/doc/srec_edux/how-change-favicon-icon" target="_blank">Change Favicon Icon</a> || <a href="https://drupar.com/doc/srec_edux/header-main-menu" target="_blank">Manage Main Menu</a> || <a href="https://drupar.com/doc/srec_edux/sliding-search-form" target="_blank">Sliding Search Form</a>'),
  ];
  // Header -> Login Links
  ...
  $form['header']['header_login']['header_login_links'] = [
    ...
    '#default_value' => theme_get_setting('header_login_links', 'srec_edux'),
  ...
  $form['header']['sticky_header'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
    '#group' => 'header_tab',
  ];
  ...
  $form['header']['header_main']['header_main_default_section']['header_main_default'] = [
    ...
    '#default_value' => theme_get_setting('header_main_default', 'srec_edux'),
  ...
  $form['header']['header_main']['header_main_section']['header_main_padding_top'] = [
    ...
    '#default_value' => theme_get_setting('header_main_padding_top', 'srec_edux'),
  ...
  $form['header']['header_main']['header_main_section']['header_main_padding_bottom'] = [
    ...
    '#default_value' => theme_get_setting('header_main_padding_bottom', 'srec_edux'),
  ...
  $form['header']['header_page']['header_page_default_section']['header_page_default'] = [
    ...
    '#default_value' => theme_get_setting('header_page_default', 'srec_edux'),
  ...
  $form['header']['header_page']['header_page_section']['header_page_padding_top'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Padding Top (rem)'),
    '#default_value' => theme_get_setting('header_page_padding_top', 'srec_edux'),
  ...
  $form['header']['header_page']['header_page_section']['header_page_padding_bottom'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Padding Bottom (rem)'),
    '#default_value' => theme_get_setting('header_page_padding_bottom', 'srec_edux'),
  ...
  $form['header']['header_page']['header_page_position_section']['header_page_content_position'] = [
    ...
    '#default_value' => theme_get_setting('header_page_content_position', 'srec_edux'),
  ...
  $form['sidebar']['front_sidebars']['front_sidebar_section']['front_sidebar'] = [
    ...
    '#default_value' => theme_get_setting('front_sidebar', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_width']['sidebar_width_default_section']['sidebar_width_default'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_width_default', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_width']['sidebar_width_section']['sidebar_width_left'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_width_left', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_width']['sidebar_width_section']['sidebar_width_right'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_width_right', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_default_section']['sidebar_block_default'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_block_default', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_section']['sidebar_padding'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_padding', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_section']['sidebar_radius'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_radius', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_section']['sidebar_margin'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_margin', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_title_section']['sidebar_title_font_size'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_title_font_size', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_title_section']['sidebar_title_transform'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_title_transform', 'srec_edux'),
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_color'] = [
    ...
    '#description'   => t('Color option is available in the premium version of this theme. <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
    '#open' => TRUE,
  ];
  /*
   * Content
  ...
  $form['content']['shortcodes'] = [
    '#type'          => 'details',
    '#title'         => t('Shortcodes'),
    '#description'   => t('<p>srec_edux theme has many custom shortcodes which you can use for creating contents.</p><p>Please visit this page for list of all available shortcodes and how to use these shortcodes.</p><ul><li><a href="https://drupar.com/node/1283/" target="_blank">Edu-X Shortcodes</a></li><li><a href="https://drupar.com/node/1211/" target="_blank">The-X Shortcodes</a></li></ul><p><hr /></p><h4>More Shortcodes</h4><p><a href="https://drupar.com/theme/srec_eduxpro">Edu-X-Pro</a> has more custom shortcodes like Tab, Accordion, icon box, card, Model etc.'),
    '#group' => 'content_tab',
  ];
  // content -> RTL
  ...
  $form['content']['content_direction']['rtl'] = [
    ...
    '#default_value' => theme_get_setting('rtl', 'srec_edux'),
    '#description'   => t('Currently not available.'),
    '#disabled'   => TRUE,
    //'#description'   => t('srec_edux theme is Right-to-left (RTL) languages compatible. Check this option to enable RTL. This feature is currently under testing phase. So, this may not work perfectly.'),
  ];
  ...
  $form['content']['submitted_details']['node_author_pic_section']['node_author_pic'] = [
    ...
    '#default_value' => theme_get_setting('node_author_pic', 'srec_edux'),
  ...
  $form['content']['submitted_details']['node_tags_section']['node_tags'] = [
    ...
    '#default_value' => theme_get_setting('node_tags', 'srec_edux'),
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#default_value' => theme_get_setting('copyright_text', 'srec_edux'),
    '#description'   => t("Check this option to show website copyright text in footer. Uncheck to hide.<br />Read more: <a href='https://drupar.com/doc/srec_edux/copyright-text-footer' target='_blank'>Copyright Text in Footer</a>"),
  ];
  ...
  $form['comment']['comment_photo']['comment_user_pic'] = [
    ...
    '#default_value' => theme_get_setting('comment_user_pic', 'srec_edux'),
  ...
  $form['comment']['comment_author']['highlight_author_comment'] = [
    ...
    '#default_value' => theme_get_setting('highlight_author_comment', 'srec_edux'),
  ...
  $form['typography']['body']['body_font_size_section']['body_font_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('body_font_size', 'srec_edux'),
  ...
  $form['typography']['body']['body_line_height_section']['body_line_height'] = [
    ...
    '#max'  => 3,
    '#step' => 0.1,
    '#default_value' => theme_get_setting('body_line_height', 'srec_edux'),
  ...
  $form['typography']['paragraph']['paragraph_section']['paragraph_bottom'] = [
    ...
    '#max'  => 3,
    '#step' => 0.1,
    '#default_value' => theme_get_setting('paragraph_bottom', 'srec_edux'),
  ...
  $form['typography']['headings']['headings_default_section']['headings_default'] = [
    ...
    '#default_value' => theme_get_setting('headings_default', 'srec_edux'),
  ...
  $form['typography']['headings']['h1']['h1_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('h1_size', 'srec_edux'),
  ...
  $form['typography']['headings']['h1']['h1_weight'] = [
    ...
    '#default_value' => theme_get_setting('h1_weight', 'srec_edux'),
  ...
  $form['typography']['headings']['h1']['h1_transform'] = [
    ...
    '#default_value' => theme_get_setting('h1_transform', 'srec_edux'),
  ...
  $form['typography']['headings']['h1']['h1_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('h1_height', 'srec_edux'),
  ...
  $form['typography']['headings']['h2']['h2_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('h2_size', 'srec_edux'),
  ...
  $form['typography']['headings']['h2']['h2_weight'] = [
    ...
    '#default_value' => theme_get_setting('h2_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h2']['h2_transform'] = [
    ...
    '#default_value' => theme_get_setting('h2_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h2']['h2_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('h2_height', 'srec_edux'),
    '#description'   => t("Default size is 1.7"),
  ];
  ...
  $form['typography']['headings']['h3']['h3_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('h3_size', 'srec_edux'),
  ...
  $form['typography']['headings']['h3']['h3_weight'] = [
    ...
    '#default_value' => theme_get_setting('h3_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h3']['h3_transform'] = [
    ...
    '#default_value' => theme_get_setting('h3_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h3']['h3_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('h3_height', 'srec_edux'),
    '#description'   => t("Default size is 1.7"),
  ];
  ...
  $form['typography']['headings']['h4']['h4_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('h4_size', 'srec_edux'),
  ...
  $form['typography']['headings']['h4']['h4_weight'] = [
    ...
    '#default_value' => theme_get_setting('h4_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h4']['h4_transform'] = [
    ...
    '#default_value' => theme_get_setting('h4_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h4']['h4_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('h4_height', 'srec_edux'),
    '#description'   => t("Default size is 1.7"),
  ];
  ...
  $form['typography']['headings']['h5']['h5_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('h5_size', 'srec_edux'),
  ...
  $form['typography']['headings']['h5']['h5_weight'] = [
    ...
    '#default_value' => theme_get_setting('h5_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h5']['h5_transform'] = [
    ...
    '#default_value' => theme_get_setting('h5_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h5']['h5_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('h5_height', 'srec_edux'),
    '#description'   => t("Default size is 1.7"),
  ];
  ...
  $form['typography']['headings']['h6']['h6_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('h6_size', 'srec_edux'),
    '#description'   => t("Value is in <strong>rem</strong> unit. 1 rem = 16px<br />Default size is 1.1rem.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h6']['h6_weight'] = [
    ...
    '#default_value' => theme_get_setting('h6_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h6']['h6_transform'] = [
    ...
    '#default_value' => theme_get_setting('h6_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['typography']['headings']['h6']['h6_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('h6_height', 'srec_edux'),
    '#description'   => t("Default size is 1.7"),
  ];
  /*
   * Elements
  ...
  $form['elements']['logo']['logo_default_section']['logo_default'] = [
    ...
    '#default_value' => theme_get_setting('logo_default', 'srec_edux'),
  ...
  $form['elements']['logo']['site_name']['site_name_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('site_name_size', 'srec_edux'),
  ...
  $form['elements']['logo']['site_name']['site_name_weight'] = [
    ...
    '#default_value' => theme_get_setting('site_name_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['elements']['logo']['site_name']['site_name_transform'] = [
    ...
    '#default_value' => theme_get_setting('site_name_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['elements']['logo']['site_name']['site_name_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('site_name_height', 'srec_edux'),
  ...
  $form['elements']['logo']['slogan']['slogan_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('slogan_size', 'srec_edux'),
  ...
  $form['elements']['logo']['slogan']['slogan_transform'] = [
    ...
    '#default_value' => theme_get_setting('slogan_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>.<br /><br /><p><hr /></p>"),
  ];
  $form['elements']['logo']['slogan']['slogan_height'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Line Height'),
    '#default_value' => theme_get_setting('slogan_height', 'srec_edux'),
    '#description'   => t("Default size is 1.7"),
  ];
  $form['elements']['logo']['slogan']['slogan_style'] = [
    ...
    '#default_value' => theme_get_setting('slogan_style', 'srec_edux'),
  ...
  $form['elements']['main_menu']['main_menu_default_section']['main_menu_default'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_default', 'srec_edux'),
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('main_menu_top_size', 'srec_edux'),
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_weight'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_top_weight', 'srec_edux'),
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_transform'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_top_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>."),
  ];
  ...
  $form['elements']['main_menu']['main_menu_sub']['main_menu_sub_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('main_menu_sub_size', 'srec_edux'),
    '#description'   => t("Default value is <strong>1rem</strong>.<br />1 rem = 16px<br /><p><hr /></p>"),
  ];
  $form['elements']['main_menu']['main_menu_sub']['main_menu_sub_weight'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_sub_weight', 'srec_edux'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><p><hr /></p>"),
  ];
  $form['elements']['main_menu']['main_menu_sub']['main_menu_sub_transform'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_sub_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>."),
  ];
  ...
  $form['elements']['page_title']['page_title_default_section']['page_title_default'] = [
    ...
    '#default_value' => theme_get_setting('page_title_default', 'srec_edux'),
  ...
  $form['elements']['page_title']['page_title_size_section']['page_title_size_desktop'] = [
    ...
    '#default_value' => theme_get_setting('page_title_size_desktop', 'srec_edux'),
  ...
  $form['elements']['page_title']['page_title_size_section']['page_title_size_mobile'] = [
    ...
    '#default_value' => theme_get_setting('page_title_size_mobile', 'srec_edux'),
  ...
  $form['elements']['page_title']['page_title_transform_section']['page_title_transform'] = [
    ...
    '#default_value' => theme_get_setting('page_title_transform', 'srec_edux'),
    '#description'   => t("Default value is <strong>None</strong>."),
  ];
  // Elements -> Button
  ...
  $form['elements']['button']['button_default_section']['button_default'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Use Default Main Menu Settings'),
    '#default_value' => theme_get_setting('button_default', 'srec_edux'),
    '#description'   => t('Check this option to use default main menu settings. Uncheck this to set custom values below.'),
  ];
  ...
  $form['elements']['button']['button_section']['button_padding'] = [
    ...
    '#default_value' => theme_get_setting('button_padding', 'srec_edux'),
  ...
  $form['elements']['button']['button_section']['button_radius'] = [
    ...
    '#default_value' => theme_get_setting('button_radius', 'srec_edux'),
  ...
  $form['components']['fonts']['fonts_section']['font_src'] = [
    ...
    '#default_value' => theme_get_setting('font_src', 'srec_edux'),
    '#description'   => t('srec_edux theme uses following Google fonts: Noto Sans.<br />You can serve these fonts locally or from Google server.'),
  ];
  // Components -> Social
  ...
  $form['components']['social']['all_icons']['all_icons_show'] = [
    ...
    '#default_value' => theme_get_setting('all_icons_show', 'srec_edux'),
  ...
  $form['components']['social']['social_profile']['facebook']['facebook_url'] = [
    ...
    '#default_value' => theme_get_setting('facebook_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['twitter']['twitter_url'] = [
    ...
    '#default_value' => theme_get_setting('twitter_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['instagram']['instagram_url'] = [
    ...
    '#default_value' => theme_get_setting('instagram_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['linkedin']['linkedin_url'] = [
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['youtube']['youtube_url'] = [
    ...
    '#default_value' => theme_get_setting('youtube_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['vimeo']['vimeo_url'] = [
    ...
    '#default_value' => theme_get_setting('vimeo_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['telegram']['telegram_url'] = [
    ...
    '#default_value' => theme_get_setting('telegram_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['whatsapp']['whatsapp_url'] = [
    ...
    '#default_value' => theme_get_setting('whatsapp_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['github']['github_url'] = [
    ...
    '#default_value' => theme_get_setting('github_url', 'srec_edux'),
  ];
  ...
  $form['components']['social']['social_profile']['vk']['vk_url'] = [
      ...
      '#default_value' => theme_get_setting('vk_url', 'srec_edux'),
  ];
  $form['components']['social']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h3>Share Page On Social networking websites</h3><p>This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Buy Edu-X-Pro for $29 only.</a></p>'),
    '#group' => 'components_tab',
  ];
  ...
  $form['components']['font_icons']['fontawesome4']['fontawesome_four'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_four', 'srec_edux'),
  ...
  $form['components']['font_icons']['fontawesome5']['fontawesome_five'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_five', 'srec_edux'),
  ...
  $form['components']['font_icons']['bootstrap_icons']['bootstrapicons'] = [
    ...
    '#default_value' => theme_get_setting('bootstrapicons', 'srec_edux'),
  ...
  $form['components']['font_icons']['materialicons'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Purchase Edu-X-Pro for $29 only.</a>'),
  ];
  ...
  $form['components']['scrolltotop']['scrolltotop_on'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_on', 'srec_edux'),
  ...
  $form['insert_codes']['head'] = [
    '#type'        => 'details',
    '#title'       => t('Head'),
    '#description' => t('<h3>Insert Codes Before &lt;/HEAD&gt;</h3><p><hr /></p>This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Buy Edu-X-Pro for $29 only.</a>'),
  ...
  $form['insert_codes']['css']['css_section']['styling'] = [
    ...
    '#default_value' => theme_get_setting('styling', 'srec_edux'),
    '#description'   => t("Check this option to enable custom styling. Uncheck to disable this feature.<br />Please refer to this tutorial page. <a href='https://drupar.com/doc/srec_edux/custom-css' target='_blank'>How To Use Custom Styling</a>"),
  ];
  ...
  $form['insert_codes']['css']['css_section']['styling_code'] = [
    ...
    '#default_value' => theme_get_setting('styling_code', 'srec_edux'),
    '#description'   => t('Please enter your custom css codes in this text box. You can use it to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://drupar.com/doc/srec_edux/custom-css" target="_blank">Custom CSS</a>'),
  ];
  ...
  $form['support']['info'] = [
    ...
    <p>Please check our documentation for detailed information on how to use Edu-X theme.<br /><a href="https://drupar.com/doc/srec_edux" target="_blank">Edu X Documentation</a>.</p>
    ...
    <hr />
    <h4>Create Issue</h4>
    <p>If you need support that is beyond our theme documentation, please <a href="https://www.drupal.org/project/issues/srec_edux?status=All&categories=All" target="_blank">Create an issue</a> at project page.</p>
    <hr />
    <h4>Contact Us</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<p><a href="https://demo2.drupar.com/srec_eduxpro/" target="_blank">srec_eduxPro Demo</a> | <a href="https://drupar.com/theme/srec_eduxpro" target="_blank">Purchase srec_eduxPro for $29 only</a></p>'),
    '#description' => t("$srec_eduxpro"),
  ];
// End form.
}
