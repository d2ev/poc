...
class __TwigTemplate_e0e113e29f35a8c51424d0c82e3c2280 extends Template
{
  ...
  <nav";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["tab"]) {
            ...
            // line 29
            yield "      ";
            $context["user_menu"] = (((($_v1 = CoreExtension::getAttribute($this->env, $this->source, ($context["tray"] ?? null), "links", [], "any", false, false, true, 29)) && is_array($_v1) || $_v1 instanceof ArrayAccess && in_array($_v1::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v1["user_links"] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["tray"] ?? null), "links", [], "any", false, false, true, 29), "user_links", [], "array", false, false, true, 29))) ? ("user-menu") : (false));
            // line 30
            yield "      ";
            if (((            // line 31
...
";
    ...
    {
        return new Source("", "themes/contrib/gin/templates/navigation/toolbar--gin.html.twig", "/var/www/html/shriramedutrust.in/web/themes/contrib/gin/templates/navigation/toolbar--gin.html.twig");
    }
